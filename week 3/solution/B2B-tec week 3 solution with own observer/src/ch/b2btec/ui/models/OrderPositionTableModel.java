...
public class OrderPositionTableModel implements TableModel, CartObserver { // TODO: Observer Pattern, step 1.3
	...
	public OrderPositionTableModel(ShoppingCart cart) {
		...
		// -- HINT: register observer...
		cart.attachObserver(this);
	}

	// -- HINT: ...and forward event to cartUpdated() method
	public void update() {
		cartUpdated();
	}
